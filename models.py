...
class Telefono(db.Model):
    ...
    sucursal_id = db.Column(
        db.Integer, db.ForeignKey("sucursal.id_sucursal"), nullable=False
    )
...
class Usuario(db.Model):
    ...
    sucursal_id = db.Column(
        db.Integer, db.ForeignKey("sucursal.id_sucursal"), nullable=True
    )
...
class Empleado(db.Model):
    ...
    usuario_id = db.Column(
        db.Integer, db.ForeignKey("usuario.id_usuario"), unique=True, nullable=True
    )
...
class Encargo(db.Model):
    ...
    codigo_materia = db.Column(
        db.String(10), db.ForeignKey("materia_prima.codigo_materia"), nullable=False
    )
...
class ImagenProducto(db.Model):
    ...
    codigo_producto = db.Column(
        db.String(10), db.ForeignKey("producto.codigo_producto"), nullable=False
    )
